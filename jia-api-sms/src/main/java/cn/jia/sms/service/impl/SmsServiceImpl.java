...
public class SmsServiceImpl implements SmsService {
	 ...
	 * @return 验证码
	 */
	public SmsCode selectSmsCodeNoUsed(String phone, Integer smsType){
	...
	public String upsert(String phone, Integer smsType){
		SmsCode smsCodeNoUsed = selectSmsCodeNoUsed(phone, smsType);
		...
		if(smsCodeNoUsed != null){
			...
			sc.setClientId(EsSecurityHandler.clientId());
			sc.setTime(now);
			sc.setCount(1);
	...
	@Override
	public SmsCode find(Integer id) {
