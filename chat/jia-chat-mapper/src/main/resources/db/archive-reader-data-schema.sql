CREATE TABLE archive_reader_progress (
    ...
    PRIMARY KEY (row_id),
    CONSTRAINT chk_archive_reader_progress_single_tenant CHECK (tenant_id = '0'),
...
CREATE TABLE archive_bookmark (
    ...
    PRIMARY KEY (row_id),
    CONSTRAINT chk_archive_bookmark_single_tenant CHECK (tenant_id = '0'),
...
CREATE TABLE archive_note (
    ...
    deleted_at                TIMESTAMP(6) NULL,
    PRIMARY KEY (row_id),
    CONSTRAINT chk_archive_note_single_tenant CHECK (tenant_id = '0'),
...
CREATE TABLE archive_idempotency (
    ...
    PRIMARY KEY (row_id),
    CONSTRAINT chk_archive_idempotency_single_tenant CHECK (tenant_id = '0'),
