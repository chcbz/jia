...
CREATE TABLE archive_bookmark (
    ...
    CONSTRAINT chk_archive_bookmark_id CHECK (bookmark_id REGEXP '^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$'),
...
CREATE TABLE archive_note (
    ...
    CONSTRAINT chk_archive_note_id CHECK (note_id REGEXP '^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$'),
