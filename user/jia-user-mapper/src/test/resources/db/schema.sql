CREATE TABLE user_info (
    ...
    weixinid varchar(32) DEFAULT NULL COMMENT '微信平台用户ID',
    weiboid varchar(32) DEFAULT NULL COMMENT '微博平台用户ID',
    githubid varchar(32) DEFAULT NULL COMMENT 'Github平台用户ID',
