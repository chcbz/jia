INSERT INTO user_perms (id, module, func, url, description, source, level, status, create_time, update_time, client_id, tenant_id) VALUES (1, 'action', 'update', 'action/update', 'hasAuthority(''action-update'')', 1, 1, 1, 1715516216763, 1737531392773, null, null);
