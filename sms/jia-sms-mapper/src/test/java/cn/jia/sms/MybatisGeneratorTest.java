...
public class MybatisGeneratorTest extends BaseDbUnitTest {
    ...
    private final static String MODULE_NAME = "sms";
    private final static String[] TABLES = new String[]{"sms_buy", "sms_code", "sms_config", "sms_message", "sms_package", "sms_reply", "sms_send", "sms_template"};
