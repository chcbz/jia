...
public class SmsConstants extends EsConstants {
	...
	/** 短信支付状态-未支付 */
	public static final Integer SMS_BUY_STATUS_NO_PAY = 0;
	/** 短信支付状态-已支付 */
	public static final Integer SMS_BUY_STATUS_HAS_PAY = 1;
	/** 短信支付状态-已取消 */
	public static final Integer SMS_BUY_STATUS_CANCELED = 2;
