...
public class MybatisGeneratorTest extends BaseDbUnitTest {
    ...
    private final static String MODULE_NAME = "mat";
    private final static String[] TABLES = new String[]{"mat_media", "mat_news", "mat_phrase", "mat_phrase_vote", "mat_pv_log", "mat_tip", "mat_vote", "mat_vote_item", "mat_vote_question", "mat_vote_tick"};
