...
import cn.jia.agent.mapper.PersonalWorkspaceConversationFileLinkMapper;
...
@Named
public class PersonalWorkspaceConversationLinkDaoImpl implements PersonalWorkspaceConversationLinkDao {
    private final PersonalWorkspaceConversationFileLinkMapper mapper;

    @Inject
    public PersonalWorkspaceConversationLinkDaoImpl(PersonalWorkspaceConversationFileLinkMapper mapper) {
    ...
    @Override
    public PersonalWorkspaceConversationFileLinkEntity findByRelation(String tenantId, String clientId,
            String ownerJiacn, String conversationId, String relationId) {
        scope(tenantId, clientId, ownerJiacn); id(conversationId, "conversationId", 100);
        id(relationId, "relationId", 100);
        return mapper.selectByRelation(tenantId, clientId, ownerJiacn, conversationId, relationId);
    }

    @Override
    public PersonalWorkspaceConversationFileLinkEntity lockByRelation(String tenantId, String clientId,
            String ownerJiacn, String conversationId, String relationId) {
        scope(tenantId, clientId, ownerJiacn); id(conversationId, "conversationId", 100);
        id(relationId, "relationId", 100);
        return mapper.selectByRelationForUpdate(tenantId, clientId, ownerJiacn, conversationId, relationId);
    }

    @Override
    public PersonalWorkspaceConversationFileLinkEntity lockBySelection(String tenantId, String clientId,
            String ownerJiacn, String conversationId, String fileId, int fileVersion, String role) {
        scope(tenantId, clientId, ownerJiacn); id(conversationId, "conversationId", 100);
        ...
        return mapper.selectBySelectionForUpdate(tenantId, clientId, ownerJiacn,
                conversationId, fileId, fileVersion, role);
    }

    @Override
    public List<PersonalWorkspaceConversationFileLinkEntity> list(String tenantId, String clientId,
            String ownerJiacn, String conversationId, Long beforeCreatedAt,
        ...
        return mapper.selectLinks(tenantId, clientId, ownerJiacn, conversationId,
                beforeCreatedAt, afterRelationId, Math.max(1, Math.min(limit, 100)));
    }

    @Override
    public List<PersonalWorkspaceConversationFileLinkEntity> listActiveByFile(String tenantId,
    ...
    @Override
    public void insert(PersonalWorkspaceConversationFileLinkEntity link) {
    ...
    public boolean changeState(String tenantId, String clientId, String ownerJiacn,
            String conversationId, String relationId, String expectedState, long expectedRevision,
        ...
        return mapper.updateState(tenantId, clientId, ownerJiacn, conversationId, relationId,
    ...
    public OperationRow reserveOperation(String tenantId, String clientId, String ownerJiacn,
        ...
        if (row == null) throw new IllegalStateException("conversation-link operation reservation missing");
        return row;
    }
