...
public interface AgentTaskWorkspaceMapper {
    ...
    @Select("""
            SELECT tenant_id, client_id, owner_jiacn, task_id, reward_status, assigned_agent_id,
            ...
            WHERE tenant_id = #{tenantId}
              ...
              AND task_id = #{taskId}
            """ + EXACT_TENANT + EXACT_CLIENT + EXACT_OWNER + EXACT_TASK + """
            LIMIT 1
            """)
    ...
    @Select("""
            SELECT tenant_id, client_id, owner_jiacn, task_id, agent_id, member_role, member_status,
    ...
    @Select("""
            SELECT tenant_id, client_id, owner_jiacn, task_id, work_item_id, title, description,
    ...
    @Select("""
            SELECT tenant_id, client_id, owner_jiacn, task_id, request_id, work_item_id,
    ...
    @Select("""
            SELECT tenant_id, client_id, owner_jiacn, task_id, artifact_id, work_item_id,
    ...
    @Select("""
            SELECT tenant_id, client_id, owner_jiacn, task_id, event_version, event_type,
