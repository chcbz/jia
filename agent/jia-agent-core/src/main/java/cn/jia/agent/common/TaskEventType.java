...
public final class TaskEventType {
    ...
    public static final String WORK_ITEM_REASSIGNED = "WORK_ITEM_REASSIGNED";
    ...
    private static final Set<String> KNOWN_TYPES = Set.of(
            ...
            WORK_ITEM_LEASE_RENEWED, WORK_ITEM_LEASE_RELEASED, WORK_ITEM_REASSIGNED,
