...
public class AgentTaskCollaborationServiceImpl
    ...
    public AgentTaskArtifactViewDTO getLatest(String tenantId, String clientId, String taskId,
        ...
        if (!isLegacyArtifact(entity) || !canReadArtifact(access, entity)) {
            throw notFound();
        }
    ...
    private boolean isLegacyArtifact(AgentTaskArtifactEntity entity) {
        return entity != null && entity.getRunId() == null;
    }
