...
public class AgentLegacyTaskCompatibilityService {
    ...
    private AssignOutcome assignResolvedLocked(
        ...
        precommitValidator.afterAssignmentRows(task, agentIds);
    ...
    public interface AssignmentPrecommitValidator {
        ...
        /** Called after assignment rows exist but before the transaction emits assignment events. */
        default void afterAssignmentRows(AgentTaskMetaEntity task, List<String> agentIds) {
        }
    }
