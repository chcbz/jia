...
class FundedBountySettlementRealTransactionTest {
    ...
    void invalidAmountsVersionsScopeOwnerAndChangedBodyWriteNothing() {
        ...
        for (FundedBountyActor actor : List.of(new FundedBountyActor(ACTOR.tenantId(), ACTOR.clientId(), ACTOR.tenantId(), "other"),
                new FundedBountyActor("tenant-w04", ACTOR.clientId(), "tenant-w04", ACTOR.userId()),
                new FundedBountyActor(ACTOR.tenantId(), "Client-other", ACTOR.tenantId(), ACTOR.userId()))) {
