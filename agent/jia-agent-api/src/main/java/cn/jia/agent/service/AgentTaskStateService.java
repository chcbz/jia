...
public interface AgentTaskStateService {
    AgentTaskStateDTO transitionTask(String tenantId, String clientId, String ownerJiacn, String taskId,
            AgentTaskStateTransitionDTO transition);

    AgentTaskStateDTO transitionMember(String tenantId, String clientId, String ownerJiacn, String taskId, String agentId,
            AgentTaskStateTransitionDTO transition);

    AgentTaskStateDTO transitionWorkItem(String tenantId, String clientId, String ownerJiacn, String workItemId,
            AgentTaskStateTransitionDTO transition);
