...
/** Browser JWT scoped conversation-to-file selection. This contract does not grant runtime file access. */
public interface PersonalWorkspaceConversationLinkService {
    LinkListView list(Scope scope, String conversationId, String cursor);
    LinkView create(Scope scope, String conversationId, CreateCommand command);
    DetachView detach(Scope scope, String conversationId, String relationId,
    ...
    record LinkView(String relationId, String conversationId, String fileId, int version,
