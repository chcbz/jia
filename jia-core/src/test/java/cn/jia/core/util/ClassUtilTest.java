...
class ClassUtilTest {
    ...
    void getClassNameByJar() {
		log.info(String.valueOf(ClassUtil.getClassName("jar:file:/D:/workspace/shunwei/jia/project/jia-api-admin/target/jia-api-admin.jar!/BOOT-INF/lib/jia-api-core-1.0.0-SNAPSHOT.jar!/cn/jia", true)));
