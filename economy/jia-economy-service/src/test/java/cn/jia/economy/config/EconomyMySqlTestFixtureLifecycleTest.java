...
/** No DB, driver, environment gate, worker thread, or process control: W02 fixture lifecycle proof only. */
class EconomyMySqlTestFixtureLifecycleTest {
    private static final String PREFIX = "w02_lifecycle";
    ...
    void driverWaitsAreFiniteEvenWhenInputRequestsInfiniteWaitsOrReconnect() {
        assertEquals("jdbc:mysql://localhost/test?useSSL=false&connectTimeout=10000&socketTimeout=2400000"
                ...
                EconomyMySqlTestFixture.boundedJdbcUrl(
