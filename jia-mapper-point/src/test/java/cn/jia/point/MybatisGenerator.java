...
public class MybatisGenerator extends BaseTest {
    ...
    private final static String MODULE_NAME = "point";
    private final static String[] TABLES = new String[]{"point_gift", "point_gift_usage", "point_record",
            "point_referral", "point_sign"};
